...
export default function TeaserBackground() {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden" style={{ backgroundColor: "#0A0E27" }}>
      <div
      ...
      <div
        className="absolute inset-0"
        style={{ background: "radial-gradient(circle at 50% 0%, rgba(212,175,55,0.06), transparent 50%)" }}
      />
      {PARTICLES.map((p, i) => (
        <span
          key={i}
